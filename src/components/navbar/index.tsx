...
export class Categories extends React.Component<CategoriesProps, any> {
    render() {
        ...
        if (isInDrawer) {
            return <DrawerLinkList>
                {popularCategories.slice(0, 10).map(
                    (c) => {
                        return <li key={c.id}>
                            <Link
    ...
    render() {
        return <StaticQuery
            ...
            render={(data: DataProps) => {
                ...
                const popularCategories = uniqBy(extractNodesFromEdges(categories.edges, "categories"), JSON.stringify);

                return <StyledNavbar fixedToTop={false}>
                    <Container>
                        ...
                        <Hide small xsmall>
                            <NavbarGroup align={Alignment.RIGHT}>
                                {typeof document !== 'undefined' && <NavbarDrawer
									width={600}
									pages={pages}
                                ...
                                {popularCategories.length > 0 && <Popover
